                        ...
                        <form class="card login-form" action="{{ route('login') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input class="form-control" type="email" name="{{ config('fortify.username') }}"  value ="dell96@example.org" id="reg-email" required>
                                </div>
                                <div class="form-group input-group">
                                    <label for="reg-fn">Password</label>
                                    <input class="form-control" type="password" name="password" value="password" id="reg-pass" required>
                                </div>
